...
using MySql.Data.MySqlClient; // Ganti SqlClient dengan MySqlClient

namespace LibraryManagementSystem
{
    public partial class IssueBooks : UserControl
    {
        MySqlConnection connect = new MySqlConnection("Server=localhost;Database=libraryapps;Uid=root;Pwd=;"); // Ganti dengan informasi koneksi MySQLmu
        ...
        public void DataBookTitle()
        {
            if (connect.State == ConnectionState.Closed)
            {
                try
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand(selectData, connect)) // Ganti SqlCommand dengan MySqlCommand
                    {
                        MySqlDataAdapter adapter = new MySqlDataAdapter(cmd); // Ganti SqlDataAdapter dengan MySqlDataAdapter
